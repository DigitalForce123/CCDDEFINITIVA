...
const routes: Routes = [
  ...
  //CARRERA
  { path: 'eventos/runcentro/inscribirlibres/miercoles', component: CarreraregistrarcodigoComponent, },// revisar inv de tallas, hacer cambio validación tallas y cambiar routing
